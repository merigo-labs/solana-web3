...
import 'package:solana_web3/config/notification_method.dart';
...
import 'package:solana_web3/rpc_data/logs_notification.dart';
import 'package:solana_web3/rpc_data/program_account.dart';
import 'package:solana_web3/rpc_data/signature_notification.dart';
import 'package:solana_web3/rpc_data/slot_notification.dart';
import 'package:solana_web3/utils/library.dart' as utils show cast;
import 'package:solana_web3/utils/types.dart' show RpcParser, u64;
...
class RpcNotificationResponse<T> {
  ...
  static RpcNotificationResponse<T> parse<T, U>(
    ...
    json[paramsKey] = parse.call(json[paramsKey]);
