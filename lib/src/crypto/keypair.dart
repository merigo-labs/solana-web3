...
class Keypair implements Signer {
  ...
  @override
  Pubkey get pubkey 
    => Pubkey.fromUint8List(_keypair.pubkey);

  /// The secret key for this keypair.
  @override
  Uint8List get seckey 
    => _keypair.seckey;
  ...
  }) => compute((_) => Keypair.fromSeckeySync(seckey, skipValidation: skipValidation), null);
  ...
  factory Keypair.fromSeckeySync(
    ...
    if (!skipValidation) {
      ...
      final Uint8List signature = nacl.sign.detached.sync(signData, keypair.seckey);
