...
class GetBlockCommitment extends JsonRpcMethod<Map<String, dynamic>, BlockCommitment> {
  ...
  @override
  BlockCommitment decoder(final Map<String, dynamic> value) => BlockCommitment.fromJson(value);
}