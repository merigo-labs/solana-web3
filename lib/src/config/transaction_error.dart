...
import 'package:solana_web3/src/utils/library.dart' as utils show tryCall;
...
enum TransactionError {
  ...
  /// 
  /// ```
  /// TransactionError.fromName('AccountInUse');
  /// ```
  factory TransactionError.fromName(final String name) => values.byName(name);
