...
class TokenAccountsFilter extends Serialisable {
  ...
  factory TokenAccountsFilter.mint(final PublicKey mint) => TokenAccountsFilter._(
    key: 'mint', 
    address: mint,
  );

  /// The public key of the Token program that owns the accounts.
  factory TokenAccountsFilter.programId(final PublicKey programId) => TokenAccountsFilter._(
    key: 'programId', 
    address: programId,
  );
