...
class MetaplexTokenMetadataProgram extends Program {
  ...
  static BorshOptionSizedCodec get metadataCreatorsCodec => borsh.vecSized(MetadataCreator.codec, 5).option();
  static BorshOptionSizedCodec get metadataCollectionCodec => MetadataCollection.codec.option();
